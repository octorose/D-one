...
const Daily = ({navigation}) => {
    ...
    return (
      ...
      <View style={{flex: 1,
        ...
        <TouchableOpacity onPress={()=> navigation.navigate('Glucosestats')} className = 'bg-gray-200  m-2 rounded-xl flex-row' style={{width:'45%', height:'30%', backgroundColor:'#ee8f91'}}>
