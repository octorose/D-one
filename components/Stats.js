  ...
  const styles = StyleSheet.create({
    up:{
      height:'100%', backgroundColor:'#fff', borderRadius:18, borderWidth:1,borderBottomWidth:-4,borderBottomRightRadius:0, borderTopLeftRadius:0, borderBottomLeftRadius:0,shadowColor: "#000000",
        ...
        return (
    <View style={{height:"70%",width:'98%', marginLeft:'auto', marginRight:'auto'}}>
      <View style={{flex:1}}>
        <View style={{}}>
            <View style={{flexDirection:'row', marginTop:30, marginBottom:30, position:'relative', height:39}}>
      ...
      <View style={{width:'99.70%',height:'100%', backgroundColor:'#fff',top:40,shadowColor: "#00",
                shadowOpacity: 0.3,
                shadowRadius: 2,
                shadowOffset: {
                  height: 3,
